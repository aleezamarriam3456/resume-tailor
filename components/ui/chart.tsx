...
// We don't extend Recharts.Tooltip props directly to avoid type conflicts, just pick necessary
interface ChartTooltipContentProps {
  ...
  nameKey?: string
  labelKey?: string
  formatter?: (value: any, name?: string, entry?: TooltipPayloadItem) => React.ReactNode | string | number
  color?: string
...
export {
  ChartContainer as Chart, // 👈 This enables: import { Chart } from ...
  ChartTooltipContent,
  ChartLegend,
  ChartLegendContent,
  ChartStyle,
